...
export default defineComponent({
  ...
  setup() {
    ...
    const postDepoimento = nuxtApp.apiCadastrarDepoimento as (depoimento: Depoimento) => Promise<any>;
    const layoutStore = useLayoutStore();

    // Tipagem do depoimento usando o tipo Depoimento
    let depoimento: Ref<Depoimento> = ref({
      nome: '',
      referencia: '',
      depoimento: ''
    });
    ...
    const cadastrarDepoimento = async () => {
      ...
      let depoimentoRes = '';
      try {
        // Tipando o resultado como string, mas pode ser ajustado dependendo do retorno real
      ...
      } catch (err: any) {  // Tipando erro como any para evitar conflitos
